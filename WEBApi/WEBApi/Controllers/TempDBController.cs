...
namespace WEBApi.Controllers
{
    [ApiController]
    [Route("[controller]")]
    public class TempDBController : ControllerBase
    {
        private readonly ILogger<TempDBController> _logger;
        private readonly LinkGenerator _linkGenerator;

        public TempDBController(ILogger<TempDBController> logger, LinkGenerator linkGenerator)
        {
            _logger = logger;
        ...
        public Drink Post(Drink drink)
        {
            try
            {
                TempDB.drinkManager.AddDrink(drink.DrinkName, drink.AviableNumbersOfDrink, drink.DrinkPrice);
